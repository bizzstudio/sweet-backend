 ...
 *                         reprint: false מדלג על ההדפסה החוזרת.
...
const update = async (noteId, patch = {}) => {
  ...
  //
  // patch.reprint === false מדלג על ההדפסה. הקורא היחיד שמבקש זאת הוא
  // תיקון חשבונית (lib/billing/reissue): שם מתוקנות כמה תעודות ברצף על
  // סחורה שנמסרה מזמן, והמסמך שמגיע ללקוח הוא החשבונית החדשה ולא ערימת
  // תעודות מודפסות מחדש.
  if (patch.reprint !== false) {
