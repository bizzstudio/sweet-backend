...
//
// הפרש מכוון אחד קיים: המסך מציג עמודת ברקוד משנית לצד המק"ט, וכאן יש
// מק"ט בלבד. המזהה של המסמך הוא המק"ט בשני המקומות — הברקוד על המסך הוא
// עזר להצלבה מול האריזה, והוא אינו ייחודי (7 קבוצות של ברקוד כפול
// בקטלוג; ראה utils/barcode.js). אין להוסיף כאן עמודת ברקוד בשם "סנכרון
// עם המסך".
//
