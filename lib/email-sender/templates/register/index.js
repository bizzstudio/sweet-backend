const customerRegisterBody = (option) => {
  ...
  xmlns:o="urn:schemas-microsoft-com:office:office" dir="rtl">
...
<body style="word-spacing:normal;background-color:#f2f3f8; direction:rtl; text-align:right;">
  <div style="background-color:#f2f3f8; padding-bottom:100px;">
          ...
          <td>
            ...
            <div style="margin:30px auto;max-width:600px; height:80px">
              <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:100%;">
                <tbody>
                  <tr>
                    <td style="direction:rtl;font-size:0px;padding:20px 0;padding-bottom:0;text-align:center;">
                                  ...
                                  <tbody>
                                    <tr>
                                      <td style="width:150px;">
                                        <!-- replace image cdn -->
                                        <img alt height="auto" src="https://i.imgur.com/5zixCOQ.png"
    ...
    <div class="body-section" style="margin: 0px auto; max-width: 600px; border border-radius:4px">
      <table align="center" cellpadding="0" cellspacing="0" role="presentation" style="width:100%;">
        <tbody>
          <tr>
            <td style="direction:rtl;font-size:0px;padding:20px 0;padding-bottom:0;padding-top:0;text-align:center;">
                    ...
                    <tr>
                      <td
                        ...
                        <div class="mj-column-per-100 mj-outlook-group-fix"
                          ...
                          <h2 style="margin-bottom:10px;">שלום ${option.name}${option.lastname ? " " + option.lastname :
                            ''}</h2>
                          <p>אנא אמת את כתובת האימייל שלך כדי להשלים את ההרשמה ולהתחבר לחשבון המשתמש שלך בתמרים בתומר.
                          </p>
                          <p style="margin-bottom:30px;">הלינק יפוג בעוד <strong>15 דקות</strong>.</p>

                          <a href="${process.env.STORE_URL}/user/email-verification/${option.token}"
                            style="background:#c09c0f;color:white;border:1px solid #c09c0f; padding: 10px 15px; border-radius: 4px; text-decoration:none;">אמת
                            חשבון</a>

                          <p style="margin-top: 35px;">אם לא ביצעת את הבקשה הזו, אנא פנה אלינו מיד ל-
                            ${process.env.EMAIL_USER}</p>

                          <p style="margin-top: 40px; text-align:center;">בברכה,<br /><strong>צוות תמרים בתומר</strong>
                          </p>
              ...
              <div class="body-section" style="margin: 0px auto; max-width: 600px; border border-radius:4px">
                <table align="center" cellpadding="0" cellspacing="0" role="presentation" style="width:100%;">
                  <tbody>
                    <tr>
                      <td
                        style="direction:rtl;font-size:0px;padding:20px 0;padding-bottom:0;padding-top:0;text-align:center;">
              ...
              <div style="background:#ffffff;background-color:#ffffff;margin:0px auto;max-width:600px;">
                <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
                  ...
                  <tbody>
                    <tr>
                      <td
                        style="direction:rtl;font-size:0px;padding:0px;padding-left:15px;padding-right:15px;text-align:center;padding-top: 0px;">

                        <div class="mj-column-per-100 mj-outlook-group-fix"
                          style="margin-left:15px; font-size:15px;text-align:right;direction:rtl;display:inline-block;vertical-align:top;width:100%;background:#ffffff;background-color:#ffffff">
                          <!--start email_template -->
                                                          ...
                                                          <tr>
                                                            <td align="center"
                                                              ...
                                                              <div
                                                                ...
                                                                אתה מקבל אימייל זה מפני שנרשמת לתמרים בתומר והסכמת לקבל
                                                                דואר אלקטרוני מאיתנו.
                                                                <p
                                                                  ...
                                                                  &copy; תמרים בתומר, כל הזכויות שמורות.</p>
                                                              </div>
                                                            </td>
                                                          </tr>
