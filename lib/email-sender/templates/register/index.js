                      ...
                      <td
                        ...
                        <div class="mj-column-per-100 mj-outlook-group-fix"
                          ...
                          <h2 style="margin-bottom:10px;">שלום ${option.name}${option.lastname ? " " + option.lastname :
                            ''}</h2>
                          <p>אנא אמת את כתובת האימייל שלך כדי להשלים את ההרשמה ולהתחבר לחשבון המשתמש שלך בהמתוקים של בני.
                          </p>
                          ...
                          <p style="margin-top: 40px; text-align:center;">בברכה,<br /><strong>צוות המתוקים של בני</strong>
                          </p>
                                                          ...
                                                          <tr>
                                                            <td align="center"
                                                              ...
                                                              <div
                                                                ...
                                                                אתה מקבל אימייל זה מפני שנרשמת להמתוקים של בני והסכמת לקבל
                                                                ...
                                                                <p
                                                                  ...
                                                                  &copy; המתוקים של בני, כל הזכויות שמורות.</p>
                                                              </div>
                                                            </td>
                                                          </tr>
