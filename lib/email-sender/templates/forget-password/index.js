                    ...
                    <tbody>
                      <tr>
                        ...
                        >
                          ...
                          >
                            <!--start email_template -->
                            <h2 style="text-align:right;">שלום ${option.name}${option.lastname ? " " + option.lastname : ''}</h2>
                            <p style="text-align:right;">התקבלה בקשה לשינוי הסיסמה לחשבון <strong>המתוקים של בני</strong> שלך.</p>
                            <p style="text-align:right;">קישור זה יפוג בעוד <strong>15 דקות</strong>.</p>
                            <p style="margin-bottom:40px;text-align:right;">לחץ על הקישור הבא כדי לאפס את הסיסמה שלך:</p>
                            <div style="text-align:right;margin-bottom:20px;">
                              <a href=${process.env.STORE_URL}/user/forget-password/${option.token} style="background:#22c55e;color:white;border:1px solid #22c55e; padding: 10px 15px; border-radius: 4px; text-decoration:none;">איפוס סיסמה</a>
                            </div>
                            <p style="margin-top: 50px;text-align:right;">אם לא אתה יזמת את הבקשה, אנא צור קשר מיד בכתובת ${process.env.EMAIL_USER}</p>
                            <p
                              style="margin:0px auto; padding-bottom:0px; text-align:center;"
                            >תודה<br/><h4 style="margin:1px; text-align:center;padding-bottom:0px;">צוות המתוקים של בני</h4></p>
                                                ...
                                                <tbody>
                                                  <tr>
                                                    ...
                                                    >
                                                      ...
                                                      >
                                                        אתה מקבל דוא"ל זה כי נרשמת להמתוקים של בני והסכמת לקבל מאיתנו עדכונים על תכונות חדשות, אירועים ומבצעים מיוחדים.
                                                        <p
