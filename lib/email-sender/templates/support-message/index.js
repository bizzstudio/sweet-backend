      ...
      >
        ...
        >
          <tbody>
            <tr>
              <td
                style='direction:ltr;font-size:0px;padding:0 0 20px;padding-left:15px;padding-right:15px;text-align:right;padding-top: 20px;'
              >
                      ...
                      <tr>
                        ...
                        >
                          ...
                          >
                            ...
                            <p>תודה שפנית אל המתוקים של בני. קיבלנו את ההודעה הבאה ממך:</p>
                            <blockquote style='margin-bottom:30px;'>“${option.message}”</blockquote>
                            <p>נציג מטעמנו יחזור אליך בטלפון ${option.phone} או בדוא"ל ${option.email} תוך 24-48 שעות.</p>
