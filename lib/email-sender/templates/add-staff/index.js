const addStaffEmailBody = (option) => {
            ...
            <tr>
              ...
              >
                ...
                >
                  ...
                  <p style="margin:0px auto; margin-top:40px; text-align:center;">תודה<br/><h4 style="margin:1px; margin-bottom:0px; text-align:center;">צוות תמרים בתומר</h4></p>
                  <!--end email_template -->
                </div>
 ...
 <h2>Hello ${option.name}</h2>
    ...
    option.cname
     ...
     <p style="margin:0px auto; margin-top:40px; text-align:center;">Thank you   <h4 style="margin:1px; margin-bottom:0px; text-align:center;">תמרים בתומר Team</p></p>
