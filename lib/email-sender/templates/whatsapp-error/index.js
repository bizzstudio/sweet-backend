...
>
  <head>
    <title>שגיאה בשליחת הודעות WhatsApp - המתוקים של בני</title>
              ...
              <td style="direction:rtl;font-size:0px;padding:30px;text-align:right;">
                ...
                <div class="error-container">
                  ...
                  <p style="color: #7f1d1d; font-size: 16px; margin: 0;">
                    זוהו ${failedMessages.length} הודעות ש<strong>נכשלו בשליחה</strong> מהשרת WhatsApp של המתוקים של בני.
                  </p>
                </div>
                ...
                <div style="text-align: center; margin-top: 40px; padding-top: 20px; border-top: 1px solid #e5e7eb;">
                  <p style="color: #6b7280; font-size: 14px; margin: 0;">
                    מייל זה נשלח אוטומטית ממערכת ניטור השגיאות של המתוקים של בני
                  </p>
