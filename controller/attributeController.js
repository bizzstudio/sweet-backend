...
const addAttribute = async (req, res) => {
  try {
    ...
    console.log('addAttribute error: ', err);
    res.status(500).send({
...
const addChildAttributes = async (req, res) => {
  try {
    ...
    console.log('addChildAttributes error: ', err);
    res.status(500).send({
      message: err.message,
    });
  }
...
const addAllAttributes = async (req, res) => {
  try {
    ...
    console.log('addAllAttributes error: ', err);
    res.status(500).send({
      message: err.message,
    });
  }
...
const getAllAttributes = async (req, res) => {
  try {
    ...
    console.log('getAllAttributes error: ', err);
    res.status(500).send({
      message: err.message,
    });
  }
...
const getShowingAttributes = async (req, res) => {
  try {
    ...
    console.log('getShowingAttributes error: ', err);
    res.status(500).send({
      message: err.message,
    });
  }
...
const updateManyAttribute = async (req, res) => {
  try {
    ...
    console.log('getShowingAttributesTest error: ', err);
    res.status(500).send({
      message: err.message,
    });
  }
...
const getAttributeById = async (req, res) => {
  try {
    ...
    console.log('getAttributeById error: ', err);
    res.status(500).send({
      message: err.message,
    });
  }
...
const getChildAttributeById = async (req, res) => {
  try {
    ...
    console.log('getChildAttributeById error: ', err);
    res.status(500).send({
      message: err.message,
    });
  }
...
const updateChildAttributes = async (req, res) => {
  try {
    ...
    console.log('updateChildAttributes error: ', err);
    res.status(500).send({
      message: err.message,
    });
  }
...
const updateManyChildAttribute = async (req, res) => {
  try {
    ...
    console.log('updateManyChildAttribute error: ', err);
    res.status(500).send({
      message: err.message,
    });
  }
...
const updateChildStatus = async (req, res) => {
  try {
    ...
    console.log('updateChildStatus error: ', err);
    res.status(500).send({
      message: err.message,
    });
  }
...
const deleteAttribute = async (req, res) => {
  try {
    ...
    console.log('deleteAttribute error: ', err);
    res.status(500).send({
      message: err.message,
    });
  }
...
const deleteChildAttribute = async (req, res) => {
  try {
    ...
    console.log('deleteChildAttribute error: ', err);
    res.status(500).send({
      message: err.message,
    });
  }
...
const deleteManyAttribute = async (req, res) => {
  try {
    ...
    console.log('deleteManyAttribute error: ', err);
    res.status(500).send({
      message: err.message,
    });
  }
...
const deleteManyChildAttribute = async (req, res) => {
  try {
    ...
    console.log('deleteManyChildAttribute error: ', err);
    res.status(500).send({
      message: err.message,
    });
  }
