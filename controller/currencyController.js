...
const addCurrency = async (req, res) => {
  try {
    ...
    console.log('addCurrency error: ', err);
    res.status(500).send({
      message: err.message,
    });
  }
...
const addAllCurrency = async (req, res) => {
  try {
    ...
    console.log('addAllCurrency error: ', err);
    res.status(500).send({
      message: err.message,
    });
  }
...
const getAllCurrency = async (req, res) => {
  try {
    ...
    console.log('getAllCurrency error: ', err);
    res.status(500).send({
      message: err.message,
    });
  }
...
const getShowingCurrency = async (req, res) => {
  try {
    ...
    console.log('getShowingCurrency error: ', err);
    res.status(500).send({
      message: err.message,
    });
  }
...
const updateCurrency = async (req, res) => {
  try {
    ...
    console.log('updateCurrency error: ', err);
    res.status(500).send({
      message: err.message,
    });
  }
...
const updateManyCurrency = async (req, res) => {
  try {
    ...
    console.log('updateManyCurrency error: ', err);
    res.status(500).send({
      message: err.message,
    });
  }
...
const updateEnabledStatus = async (req, res) => {
  try {
    ...
    console.log('updateEnabledStatus error: ', err);
    res.status(500).send({
      message: err.message,
    });
  }
...
const updateLiveExchangeRateStatus = async (req, res) => {
  try {
    ...
    console.log('updateLiveExchangeRateStatus error: ', err);
    res.status(500).send({
      message: err.message,
    });
  }
...
const deleteCurrency = async (req, res) => {
  try {
    ...
    console.log('deleteCurrency error: ', err);
    res.status(500).send({
      message: err.message,
    });
  }
...
const deleteManyCurrency = async (req, res) => {
  try {
    ...
    console.log('deleteManyCurrency error: ', err);
    res.status(500).send({
      message: err.message,
    });
  }
