...
const addNotification = async (req, res) => {
  try {
    ...
    console.log('addNotification error: ', err);
    res.status(500).send({
      message: err.message,
    });
  }
...
const updateStatusNotification = async (req, res) => {
  try {
    ...
    console.log('updateStatusNotification error: ', err);
    res.status(500).send({
      message: err.message,
    });
  }
...
const updateManyStatusNotification = async (req, res) => {
  try {
    ...
    console.log('updateManyStatusNotification error: ', err);
    res.status(500).send({
      message: err.message,
    });
  }
...
const deleteNotificationById = async (req, res) => {
  try {
    ...
    console.log('deleteNotificationById error: ', err);
    res.status(500).send({
      message: err.message,
    });
  }
...
const deleteNotificationByProductId = async (req, res) => {
  try {
    ...
    console.log('deleteNotificationByProductId error: ', err);
    res.status(500).send({
      message: err.message,
    });
  }
...
const deleteManyNotification = async (req, res) => {
  try {
    ...
    console.log('deleteManyNotification error: ', err);
    res.status(500).send({
      message: err.message,
    });
  }
